import{_ as s,c as n,o as a,a as l}from"./app.6b43edd3.js";const d=JSON.parse('{"title":"介绍","description":"","frontmatter":{"pageClass":"getting-started"},"headers":[{"level":2,"title":"功能","slug":"功能","link":"#功能","children":[]},{"level":2,"title":"前序准备","slug":"前序准备","link":"#前序准备","children":[]},{"level":2,"title":"目录结构","slug":"目录结构","link":"#目录结构","children":[]},{"level":2,"title":"安装","slug":"安装","link":"#安装","children":[]},{"level":2,"title":"Contribution","slug":"contribution","link":"#contribution","children":[]}],"relativePath":"guide/README.md","lastUpdated":1678525999000}'),p={name:"guide/README.md"},e=l(`<h1 id="介绍" tabindex="-1">介绍 <a class="header-anchor" href="#介绍" aria-hidden="true">#</a></h1><p><a href="https://github.com/LaiBaoYuan/react-antd-admin" target="_blank" rel="noreferrer">react-antd-admin</a> 是一个后台前端解决方案，它基于 <a href="https://react.docschina.org/" target="_blank" rel="noreferrer">react</a> 和 <a href="https://ant.design/index-cn" target="_blank" rel="noreferrer">ant-design</a>实现。它使用了最新的前端技术栈，内置了动态路由，权限验证，提炼了典型的业务模型，提供了丰富的功能组件，它可以帮助你快速搭建企业级中后台产品原型。相信不管你的需求是什么，本项目都能帮助到你。</p><br><h2 id="功能" tabindex="-1">功能 <a class="header-anchor" href="#功能" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">- 登录 / 注销</span></span>
